// <copyright file="TlumachRequiredAttribute.cs" company="Allied Bits Ltd.">
//
...
{
    /// <summary>
    /// A <see cref="RequiredAttribute"/> that takes its error message from a class created by Tlumach Generator.
    ...
    public sealed class TlumachRequiredAttribute : RequiredAttribute, ITlumachLocalizedErrorMessage
    {
        private readonly TlumachMessageResolver _resolver;

        /// <summary>
        /// Initializes a new instance of the <see cref="TlumachRequiredAttribute"/> class. Set <see cref="TranslationClass"/> and <see cref="TranslationKey"/> in the annotation, or leave both unset to
        /// behave exactly like <see cref="RequiredAttribute"/>.
        /// </summary>
        public TlumachRequiredAttribute()
        {
            _resolver = new TlumachMessageResolver(this);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="TlumachRequiredAttribute"/> class that takes its message from the given translation.
        /// </summary>
