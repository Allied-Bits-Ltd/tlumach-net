// <copyright file="TlumachEmailAddressAttribute.cs" company="Allied Bits Ltd.">
//
...
namespace Tlumach.DataAnnotations
{
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="EmailAddressAttribute"/> is sealed, so this attribute derives from <see cref="DataTypeAttribute"/> the way the sealed one does and delegates the check itself to an instance of it. The
    /// rule is therefore identical to the one of the framework and follows any future correction of it, and no expression from the framework is copied into Tlumach.
    /// </remarks>
    [AttributeUsage(AttributeTargets.Property | AttributeTargets.Field | AttributeTargets.Parameter, AllowMultiple = false)]
    public sealed class TlumachEmailAddressAttribute : DataTypeAttribute, ITlumachLocalizedErrorMessage
    {
        private static readonly EmailAddressAttribute StockRule = new();

        private readonly TlumachMessageResolver _resolver;

        /// <summary>
        /// Initializes a new instance of the <see cref="TlumachEmailAddressAttribute"/> class. Set <see cref="TranslationClass"/> and <see cref="TranslationKey"/> in the annotation, or leave both unset to
        /// behave exactly like <see cref="EmailAddressAttribute"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TlumachEmailAddressAttribute"/> class that takes its message from the given translation.
        /// </summary>
        ...
        /// <summary>
        /// Tells whether the value is a valid e-mail address, using the rule of <see cref="EmailAddressAttribute"/>.
        /// </summary>
        /// <param name="value">The value to check.</param>
        /// <returns><see langword="true"/> when the value is <see langword="null"/> or a valid e-mail address.</returns>
