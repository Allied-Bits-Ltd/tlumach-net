...
**4. Create and set up a [translation project](glossary.cmd)**
...
To retrieve the value for a different culture (e.g., in a server application), use the <xref:Tlumach.TranslationUnit.GetValue> method:
