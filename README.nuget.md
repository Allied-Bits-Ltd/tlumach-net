...
* Handling of translation files in JSON, Arb (JSON with additional features, used in Dart/Flutter), simple INI, TOML, CSV and TSV, and .NET ResX formats as well as the industry-standard XLIFF 2.2 format and Apple-specific .xcstrings (XCode String Catalog) format.
